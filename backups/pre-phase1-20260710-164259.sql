...
CREATE TABLE IF NOT EXISTS "public"."boe_share_links" (
    ...
    CONSTRAINT "boe_share_links_link_type_check" CHECK (("link_type" = ANY (ARRAY['accountant'::"text", 'boe'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."company_settings" (
    ...
    "rate_source" "text" DEFAULT 'internal'::"text",
...
CREATE TABLE IF NOT EXISTS "public"."proposals" (
    ...
    CONSTRAINT "proposals_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'in_progress'::"text", 'submitted'::"text", 'won'::"text", 'lost'::"text", 'archived'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."wbs_elements" (
    ...
    "element_type" "text" DEFAULT 'task'::"text",
...
CREATE INDEX "idx_requirements_proposal_id" ON "public"."requirements" USING "btree" ("proposal_id");
...
CREATE INDEX "idx_wbs_elements_parent_id" ON "public"."wbs_elements" USING "btree" ("parent_id");



CREATE INDEX "idx_wbs_elements_proposal_id" ON "public"."wbs_elements" USING "btree" ("proposal_id");
...
CREATE OR REPLACE TRIGGER "update_boe_share_links_updated_at" BEFORE UPDATE ON "public"."boe_share_links" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_company_roles_updated_at" BEFORE UPDATE ON "public"."company_roles" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_wbs_elements_updated_at" BEFORE UPDATE ON "public"."wbs_elements" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."wbs_elements"
    ADD CONSTRAINT "wbs_elements_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."wbs_elements"("id") ON DELETE CASCADE;
...
CREATE POLICY "Owner manages coaching" ON "public"."section_coaching" USING (("proposal_id" IN ( SELECT "p"."id"
